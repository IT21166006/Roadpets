...
const Slider = () => {
  ...
  const slides = [
    {
      img: require('../asserts/slider/2.png'), // Replace with your image source
      label: 'Hope for Every Stray',
      text: 'Every road pet deserves a loving home—lets make it happen by 2030!',
    },
    {
      img: require('../asserts/slider/1.png'), // Replace with your image source
      label: 'Rescue & Rehome',
      text: 'Lost, but not forgotten—help us find them a forever home.',
    },
    {
      img: require('../asserts/slider/3.png'), // Replace with your image source
